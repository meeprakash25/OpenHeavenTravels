...
<header id="main-header" class="py-4 bg-info text-white">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<h3>
					<i class="fa fa-image"></i> Manage Gallery Images</h3>
			</div>
			<div class="col-md-4">
				<?php
						...
						<table class="table table-hover">
							...
							<?php foreach ($image_set as $image): ?>
								<tr>
									...
									<td>
										<a href="<?php echo url_for('/admin/gallery_images/edit.php?id=' . h(u($image['id']))); ?>"
										   class="btn btn-secondary my-1">
											<i class="fa fa-edit"></i> Edit
										</a>
										<a href="<?php echo url_for('/admin/gallery_images/delete.php?id=' . h(u($image['id']))); ?>"
